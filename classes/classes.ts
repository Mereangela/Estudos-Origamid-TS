...
class Produto {
    readonly tipo = 'produto'; //Aqui eu libero somente para leitura.
    nome: string;
    private preco: number; //Eu não deixo acessar fora da classe e privada só dentro desta classe e o protected permite utilizar nas subclasses.
    constructor(nome: string, preco:number) {
        this.nome = nome;
        this.preco = preco;
    }
    getPreco() { // Aqui eu dou acesso na classe privada do preço.
